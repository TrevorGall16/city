...
`.claude/SKILL.md` is the active design contract (DESIGN_VARIANCE=8, MOTION_INTENSITY=6, VISUAL_DENSITY=4 by default). Read it before frontend work. Highlights:
