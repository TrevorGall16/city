...
export default function ProfileForm() {
  ...
  // State to track if name was ALREADY set on load (to lock it)
  ...
  useEffect(() => {
    const getProfile = async () => {
      try {
        ...
        if (user) {
          // Check metadata first (where we store display names usually)
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              disabled={isNameLocked} // ✅ Disabled if name exists
              className={`
