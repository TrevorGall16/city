    ...
    >
      ...
      <div className="mb-16 p-8 bg-blue-50 dark:bg-blue-900/10 rounded-3xl border border-blue-100 dark:border-blue-800/30">
        ...
        <p className="text-lg text-slate-700 dark:text-slate-300 leading-relaxed max-w-3xl">
          I'm a guy who loves traveling and build website. I built this for two things: I wanted to learn how to build a website with AI, and because I was tired of reading 20-page blog posts just to find one good coffee shop.
          <br /><br />
